        ...
        >
          {isLoading || userLoading ? (
            ...
            <>
              ...
              <div className="bg-black/30 px-3 py-3 border-t border-slate-800 flex flex-col">
                {gameListEntry.isInList || gameListEntry.review ? (
                  <div className="flex justify-between items-center w-full">
                    <Button
                      onClick={() => setShowDeleteConfirm(true)}
                      variant="ghost"
                      className="text-slate-300 hover:text-white hover:bg-transparent text-xs sm:text-sm"
                      disabled={isSaving}
                    >
                    ...
                    <Button 
                      onClick={handleSave} 
                      disabled={isSaving}
                      className="bg-slate-200 hover:bg-white text-slate-900 font-medium px-4 sm:px-8 py-1 sm:py-2 rounded-full text-xs sm:text-sm w-full sm:w-auto"
                    >
                      {isSaving ? (
                        <div className="flex items-center gap-2 justify-center">
                          <div className="w-3 h-3 sm:w-4 sm:h-4 border-2 border-t-slate-400 border-slate-900 rounded-full animate-spin"></div>
                          <span>Saving...</span>
                        </div>
                      ) : (
                        'Update'
